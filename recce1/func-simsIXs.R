...
simsIXs<-function(nruns,sampledf,nironXs,ntransects,ironX0,w,yp10,ym10,yp8,ym8,i1area,darea)
{
...
#        initD[[2]]<- create.lines(study.area,nlines=4,width=.002,angle=180)
